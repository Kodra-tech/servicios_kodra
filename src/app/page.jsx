  ...
  return (
    <>
      <nav>
        ...
        {/* El botón CTA se oculta en móviles (lo reemplaza el menú) o se puede mover dentro del menú */}
        <a href="#contacto" className="btn btn-primary nav-cta" style={{ padding: "0.5rem 1.2rem", fontSize: "0.82rem", display: "none" }}>
          Contáctanos
        </a>
      </nav>
      ...
      <section className="hero">
        <div className="hero-inner">
          <div className="hero-badge">Disponibles para nuevos proyectos</div>
          <h1>
            Desarrollo Web<br />
            <span className="line2">Profesional</span>
          </h1>
          <p className="hero-sub">
            Construimos páginas web y sistemas para <span>negocios y empresas</span> — soluciones rápidas, modernas y totalmente adaptables. Con base en <span>México</span>.
          </p>
          <div className="hero-ctas">
            <a href="#proyectos" className="btn btn-primary">Ver nuestros proyectos</a>
      ...
      <section className="servicios" id="servicios">
        <div className="section-inner">
          ...
          <h2 className="section-title reveal">Soluciones Digitales</h2>
          ...
          <div className="contacto-inner">
            <div className="contacto-text reveal">
              ...
              <div className="contacto-links">
                ...
                <a href="mailto:hola@kodrasoluciones.com" className="contacto-link">
                  <div className="link-icon">✉️</div>
                  <span>hola@kodrasoluciones.com</span>
                </a>
              </div>
            </div>
            ...
            <div className="reveal">
              <form onSubmit={enviarWA}>
                ...
                <div className="form-group">
                  <label>Cuéntanos sobre tu necesidad</label>
                  <textarea 
      ...
      <footer>
        <p>Kodra Soluciones — Potenciando negocios con tecnología · <span id="year">{new Date().getFullYear()}</span></p>
      </footer>
    </>
  );
}
